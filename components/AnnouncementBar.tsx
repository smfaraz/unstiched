      ...
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-col md:flex-row items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-4 shrink-0 text-[11px]">
          ...
          >
            ...
            <span>WhatsApp Styling: +91 98200 89123</span>
          </a>

          {/* Quick Track Order */}
          <button
            onClick={() => openOrderTracking()}
            className="flex items-center gap-1 hover:text-[#F5DEB3] transition text-[#FAF9F6]/90 uppercase tracking-widest text-[10px] font-semibold"
            id="header-track-order-btn"
          >
            <Package className="w-3.5 h-3.5 text-[#F5DEB3]" />
            <span className="hidden sm:inline">Track Order</span>
          </button>

          {/* Currency Switcher */}
          <div className="flex items-center bg-black/30 px-2 py-0.5 rounded-sm border border-white/20 text-[10px] font-semibold tracking-wider">
          ...
          <button
            onClick={openAdmin}
            className="hidden md:flex items-center gap-1 text-[#FAF9F6]/80 hover:text-white transition px-2 py-0.5 rounded-sm hover:bg-black/30 text-[10px] uppercase tracking-wider font-semibold border border-white/10"
